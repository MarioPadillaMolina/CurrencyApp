            ...
            <table class="table table-hover">
                ...
                @foreach ($monedas as $moneda)
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ url('backend/moneda/' . $moneda->id) }}"><i class="fas fa-eye" aria-hidden="true"></i></a></td>
                        <td class="text-center"><a href="{{ url('backend/moneda/' . $moneda->id . '/edit') }}"><i class="fas fa-edit" aria-hidden="true"></i></a></td>
                        <td class="text-center"><i data-toggle="modal" data-target="#modalDelete" class="fas fa-trash" style="color: darkred; cursor: pointer"></i></td>
                    </tr>
                @endforeach
            </table>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" data-id="{{ $moneda->id }}" data-name="{{ $moneda->name }}" class="btn btn-primary enlaceBorrar">Delete</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
