...
<head>
  ...
  <title>Currency App | Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('backend.main') }}" class="brand-link">
      <img src="{{ url("assets/backend/dist/img/AdminLTELogo.png") }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Currency App</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ $currencyOpen ?? ''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('backend.moneda.create') }}" class="nav-link {{ $createOpen ?? ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Currency</p>
                </a>
              </li>
